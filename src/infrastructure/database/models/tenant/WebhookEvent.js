...
// so the other document event types (createQuotation / updateQuotation /
// convertQuotationToOrder / inventoryTransferRequest) rely on application-level dedup
// (queueWebhookEvent) plus the unique index on SapDocumentLinks
// (hubspotCredentialId + dealId + documentType) for race-safe idempotency.
